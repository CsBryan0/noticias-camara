...
function App() {
  // Mock de noticías planilha

  const [links, setLinks] = useState([])

  useEffect(() => {
    fetch(import.meta.env.VITE_SHEETY_URL)
      .then(res => res.json())
      .then(data => {
        // Inverte a ordem (últimos adicionados aparecem primeiro)
        setLinks(data.página1.reverse());
      });
  }, []);
  ...
  return (
    <div className="min-h-screen bg-blue-900  flex flex-col items-center p-4">
      ...
      <div class="bg-blue-900 w-full h-auto py-8 flex items-center justify-center gap-2 flex-wrap">
        <a href="http://facebook.com/cmsantaleopoldina/" target="_blank"
          class="bg-white p-2 rounded-lg flex items-center border border-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
        ...
        <a href="https://www.instagram.com/camarasantaleopoldina" target="_blank"
          class="bg-white p-2 rounded-lg flex items-center border border-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 71 72"
            fill="none">
            <path
        ...
        <a href="https://www.youtube.com/@camarasantaleopoldina" target="_blank"
          class="bg-white p-2 rounded-lg flex items-center border border-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
      ...
      <h3 className="text-center font-bold mb-6 text-slate-100">Canal Institucional da Câmara Municipal de Santa Leopoldina (CMSL)  </h3>

      <div class="h-px w-full bg-gray-300"></div>

      {/* Título */}
      <h2 className="text-2xl font-bold mb-6 text-slate-100 mt-6">
        Últimas Notícias
      </h2>

      {/* Grid de notificias */}

      <div className="grid gap-6 w-full max-w-2x1 sm:grid-cols-2">
        {links.map((item, i) => (
          <a
            href={item.links}
            key={i}
            ...
            className="bg-white rounded-2x1 shadowl-md overflow-hidden hover:scale-[1.02] transition-transform"
          >
